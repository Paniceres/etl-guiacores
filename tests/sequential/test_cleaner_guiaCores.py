...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('data/logs/cleaner/test_cleaner.log'),
...
def test_clean_leads_csv():
    """Prueba la función clean_leads_csv"""
    # Crear directorios de prueba
    os.makedirs('data/raw/csv', exist_ok=True)
    os.makedirs('data/processed/csv', exist_ok=True)
    
    # Crear archivo de prueba
    test_input = 'data/raw/csv/test_leads.csv'
    test_output = 'data/processed/csv/test_leads_cleaned.csv'
